...
const AGREEMENT_TEXT = [
  { heading: '1. Purpose', body: 'FitPass India operates a digital platform that enables customers to discover, book, and access partner gyms through the FitPass India mobile application. You agree to onboard your fitness facility on the platform under these terms.' },
  { heading: '2. Appointment', body: 'You authorize FitPass India to list, promote, and market your gym through the FitPass India platform.' },
  { heading: '3. Commission', body: 'You agree to pay FitPass India 10% commission on every successful booking or visit generated through the app. The remaining amount is transferred to you after deducting the commission, taxes, and any statutory deductions.' },
  { heading: '4. Customer Experience', body: 'You agree to welcome every FitPass India customer professionally, treat them with courtesy and respect, provide equal service to app users and direct members, ensure staff behave professionally, and resolve complaints promptly.' },
  ...
  { heading: '6. Booking Acceptance', body: 'You will honor all confirmed bookings received through FitPass India during operating hours, unless the gym is temporarily closed due to unavoidable circumstances.' },
  ...
  { heading: '8. Pricing', body: 'The rates displayed on FitPass India shall be honored for all confirmed bookings. No additional charges shall be collected from customers unless clearly disclosed and accepted through the platform.' },
  { heading: '9. Cancellation', body: 'You will immediately notify FitPass India in case of temporary closure, renovation, maintenance, emergency, or holiday closure.' },
  { heading: '10. Payment Settlement', body: 'FitPass India shall settle payments to you according to the agreed settlement cycle after deducting the 10% commission, applicable taxes, and refunds (if any).' },
  ...
  { heading: '12. Customer Feedback', body: 'FitPass India may collect customer ratings and reviews. Repeated poor ratings or verified complaints may result in temporary suspension, delisting from the platform, or termination of this agreement.' },
  { heading: '13. Marketing Rights', body: 'You authorize FitPass India to use your gym name, logo, interior photographs, videos, and promotional content for marketing and promotional purposes.' },
  ...
  { heading: '16. Termination', body: 'Either party may terminate this agreement with thirty (30) days\u2019 written notice. FitPass India may terminate immediately if you engage in fraud or misconduct, misuse the platform, provide unsafe facilities, repeatedly refuse confirmed bookings, or receive repeated verified customer complaints.' },
  { heading: '17. Indemnity', body: 'You are solely responsible for any injury, accident, loss, or damage occurring within your gym premises due to negligence or failure to maintain safe facilities. FitPass India acts only as a technology platform facilitating bookings and is not liable for your operational acts or omissions.' },
...
const ACCEPTANCE_CLAUSE = 'I have read and accept all the terms above, and I agree to grant entry to any verified FitPass India member who arrives at my gym with a confirmed booking made through the app.';
...
export default function OwnerAgreementScreen({ gym, onBack, onSigned }) {
  ...
  function handleSubmit() {
    ...
    setSubmitting(true);
    // This triggers handleSignatureOK above with the drawn image, which does the actual upload + submit.
      ...
      <View style={styles.root}>
        ...
        <ScrollView contentContainerStyle={{ padding: 20, alignItems: 'center' }}>
          <View style={styles.signedCard}>
            ...
            <Text style={styles.signedBy}>Your gym is now visible to FitPass India members.</Text>
