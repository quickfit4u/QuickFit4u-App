...
// 'YYYY-MM-DD' <-> 'DD/MM/YYYY' — stored as ISO on the server, shown in the
// friendlier Indian day-first format in the form.
        ...
        <View style={styles.form}>
          ...
          <Field label="Date of Birth">
            <TextInput
              ...
              value={dateOfBirth}
              onChangeText={(t) => {
                // Auto-insert the '/' separators as digits are typed: DD/MM/YYYY.
